class Cart {
    ...
    const selectEl = document.querySelector(`.js-select-${productId}`);
    const quantitySelect = selectEl ? Number(selectEl.value) : 1; // default 1 if missing
    ...
    calculateCartQuantity(txtchose){
        let cartQuantity = 0;  
